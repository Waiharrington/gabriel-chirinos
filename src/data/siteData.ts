export const siteData = {
  personal: {
    ...
    firstName: "Gabriel",
    lastName: "Chirinos",
    tagline: "CREADOR DE CONTENIDO & ATLETA",
    headline: "CONECTO MARCAS CON PERSONAS",
    headlineScript: "en movimiento.",
    description:
  ...
  community: {
    ...
    videos: [
      ...
      },
      {
        ...
        image: "/photos/reel-covers/mcy-run.jpg",
      },
      {
        title: "BURGER MÁSTER",
  ...
  footer: {
    copyright: "© 2024. Gabriel Chirinos. Todos los derechos reservados.",
  },
};
