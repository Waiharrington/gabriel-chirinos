...
export const EDITABLE_GROUPS: ElementGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "stat-item-0", label: "Métrica 1: 24.250 Seguidores" },
      { id: "stat-item-1", label: "Métrica 2: 4.639.715 Visualizaciones" },
      { id: "stat-item-2", label: "Métrica 3: 2.156.994 Espectadores" },
      { id: "stat-item-3", label: "Métrica 4: +1.476 Seguidores netos" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: "comunidad-videos-grid", label: "Cuadrícula de 8 Reels" },
      { id: "comunidad-video-0", label: "Reel 1: Nevo 1" },
      { id: "comunidad-video-1", label: "Reel 2: MCY Run" },
      { id: "comunidad-video-2", label: "Reel 3: Burger Máster" },
      { id: "comunidad-video-3", label: "Reel 4: Adidas" },
      { id: "comunidad-video-4", label: "Reel 5: Nevo 2" },
      { id: "comunidad-video-5", label: "Reel 6: Giunti" },
      { id: "comunidad-video-6", label: "Reel 7: Zizou" },
      { id: "comunidad-video-7", label: "Reel 8: Brth" },
    ],
  },
  {
