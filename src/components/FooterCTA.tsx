        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="text-right">
              <div className="text-white/10 text-[4rem] xl:text-[6rem] font-black leading-none tracking-tighter">
                LA
              </div>
              <div className="text-white/10 text-[4rem] xl:text-[6rem] font-black leading-none tracking-tighter -mt-2">
                VUELTA.
              </div>
