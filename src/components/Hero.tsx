      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-8 sm:px-16 lg:px-24 flex items-center h-full">
        <div className="max-w-xl py-6">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 border border-[#E53935]/40 bg-[#1c0808]/85 backdrop-blur-md px-3.5 py-1.5 mb-4 rounded-full shadow-lg shadow-red-950/30"
          >
          ...
          <motion.h1
            ...
            className="text-white text-[3.4rem] sm:text-[4.6rem] lg:text-[5.4rem] font-black leading-[0.88] uppercase tracking-tight font-bebas drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)]"
          >
            CONECTO MARCAS<br />
          ...
          <motion.p
            ...
            className="font-script text-[#E53935] text-[2.8rem] sm:text-[3.8rem] lg:text-[4.2rem] -mt-2 sm:-mt-3 mb-4 select-none drop-shadow-[0_4px_12px_rgba(229,57,53,0.35)] leading-none"
          >
          ...
          <motion.p
            ...
            className="text-white/85 text-xs sm:text-sm md:text-[14.5px] leading-relaxed max-w-md mb-8 font-inter drop-shadow"
          >
